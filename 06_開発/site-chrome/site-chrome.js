...
(function () {
    ...
    '<div class="menu-overlay">' +
      '<div class="overlay-links">' +
        '<div class="overlay-links__group">' +
          ...
          '<a href="https://growthfix.jp/service" class="overlay-links__lead d-flex flex-center">サービス</a>' +
  ...
  var HEADER =
    '<div class="header d-flex flex-row align-center flex-between">' +
      ...
      '<ul class="link d-flex flex-row align-center">' +
        ...
        '<li><a href="https://growthfix.jp/service" class="link_btn"><span>サービス</span></a></li>' +
    ...
    '<footer class="b-footer">' +
      '<div class="container b-footer-inner">' +
        '<div class="b-brand">GrowthFix<br>' +
          '<span class="b-footer-tagline">自分を取り戻すと、組織が動き出す。</span><br>' +
          '<span class="b-footer-tagline-sub">組織に、引力を。</span>' +
        '</div>' +
        '<div class="b-footer-profile">' +
          '<p class="b-footer-profile-name"><strong>石井伸幸</strong> ── 組織の引力研究の人</p>' +
        ...
        '<div class="b-footer-links">' +
          ...
          '<div class="b-footer-col">' +
            ...
            '<a href="https://growthfix.jp/gravity-shift/">Gravity Shift R</a>' +
            '<a href="https://growthfix.jp/gravity-shift-a/">Gravity Shift A</a>' +
          '</div>' +
          '<div class="b-footer-col">' +
  ...
  function mount() {
    ...
    // DOM挿入は2回にまとめる（reflow削減）
    // SPハンバーガーは body 直下で position:fixed が確実に効くよう beforeend に
