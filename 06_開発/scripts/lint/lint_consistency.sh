...
# ----------------------------------------------------------------------
# [1.7] 月額表記必須語チェック（v5.0・260514 月額制 + 最低 6 ヶ月）
# v5.0 確定価格マップ:
#   - Recruit (集まる):     月 35 万・最低 6 ヶ月
#   - Cultivate (躍動する): 月 50 万・最低 6 ヶ月
#   - Orbit (留まる):       月 15 万・最低 6 ヶ月
...
check_monthly_pricing "Gravity/Orbit/LP/index.html" "Orbit（月 15 万・最低 6 ヶ月）" "月 ?15 *万"
