...
【ebook】「1on1」パーフェクトガイドブック_powered_by_SELECK.pdf を Markdown形式に変換
"""
...
if __name__ == "__main__":
    # PDFファイルのパス
    pdf_file = Path("/Users/ishiinobuyuki/Documents/Obsidian Vault/【ebook】「1on1」パーフェクトガイドブック_powered_by_SELECK.pdf")
