...
使用例:
  python3 cultivate_vision_engine.py --demo
  python3 cultivate_vision_engine.py --demo --dry-run
  python3 cultivate_vision_engine.py --input profile.json --output report
  python3 cultivate_vision_engine.py --input profile.json --output report --mask
        """,
    )
    ...
    if args.demo:
        ...
        output_base = args.output or os.path.join(SCRIPT_DIR, "cultivate_samples", "vision_engine_demo")
