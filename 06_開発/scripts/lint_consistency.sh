...
check_required "GravityShift/LP/index.html" "変革の参謀"
...
# ----------------------------------------------------------------------
# 5. 5サービスLPに「TOPのFAQ」導線があるか
# ----------------------------------------------------------------------
echo ""
echo "[5] 5サービスLPの「TOP のFAQ」導線"
top_link_missing=0
for lp in GravityCode GravityScan GravityCoaching GravityShift GravityOrbit; do
...
[ "$top_link_missing" -eq 0 ] && echo -e "${GRN}✓${NC} 全5LPにTOP導線あり"
...
corporate_missing=0
for term in "引力の参謀" "心の参謀" "変革の参謀" "共鳴の参謀"; do
...
[ "$corporate_missing" -eq 0 ] && echo -e "${GRN}✓${NC} 4 参謀名（CODE/Scan は『引力の参謀』共有・心・変革・共鳴）が top / service / news に展開済み"
