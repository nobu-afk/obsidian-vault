...
# 各videoに対し ja-orig > ja の優先順位で1つだけ採用
videos = {}
for vtt in sorted(glob.glob(f"{IN_DIR}/*.vtt")):
    fname = os.path.basename(vtt)
    # e.g. eFle1SxIdz4.ja-orig.vtt or eFle1SxIdz4.ja.vtt
