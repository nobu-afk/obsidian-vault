...
| ~~12~~ | ~~`05_プロダクト/TrueFit/LP/coaching/index.html`~~ | **🔴 260507 廃止アーカイブ済**（ペンディングサービス TRUE FIT Coaching の LP・`_archive/260507_TrueFit_ペンディング廃止/` 移動済）。**過去事故：本ファイルを `/gravity-coaching/` に誤デプロイ。詳細：`memory/feedback_lp_deployment_path_ssot_check.md`**|
