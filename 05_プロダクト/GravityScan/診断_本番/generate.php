...
8. **★ 理論背景（theory-background-box・260508 夜 追加・権威性訴求・closing-note の直前に表示・1 段落）**
   ...
   **HTML 構造：**
   ...
   <div class="theory-background-box">
     ...
     <p class="theory-intro" style="margin-top:14px;font-weight:600;color:#475569;">Scan 4 型診断の精緻化（260510 Phase 8 シャープ化反映）</p>
     <ul class="theory-list">
     ...
     <p class="theory-intro" style="margin-top:14px;font-weight:600;color:#475569;">🔥 思想層バックボーン（Bandura 効力感理論・Stanford・260510 Phase 9 追加）</p>
     <ul class="theory-list">
       <li><strong>組織の引力 4 型 = 集合的効力感パターン診断の理論基盤</strong>── Bandura, A. (2000) <em>Exercise of human agency through collective efficacy</em>, Current Directions in Psychological Science, 9(3), 75-78.（被引用 1,721）</li>
       <li><strong>学校組織の集合的効力感研究（組織応用の起点）</strong>── Goddard, R. D., Hoy, W. K., &amp; Woolfolk Hoy, A. (2000) <em>Collective teacher efficacy</em>, American Educational Research Journal, 37(2), 479-507.（被引用 839）</li>
     </ul>
