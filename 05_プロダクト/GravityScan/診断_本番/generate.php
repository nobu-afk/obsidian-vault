...
4. **【★ 260510 v0.4 新規】PO Fit 認識スコア**（採用候補者・内定者の価値観一致認識）── 出典：Cable & Judge 1996 ／ 価値観一致度・求人共鳴度・面接時の温度感の自己評価（候補者側）or 経営者の主観評価。**集まる軸の質的指標**として機能。応募はあるが Fit 認識が低い → 量より質の問題と判定

【躍動軸 4 項目】
5. 優秀人材定着率（過去 2 年の優秀人材入社・離脱の数値）
6. **【★ 260510 v0.4 改訂】心理的安全性 4 行動**（旧「幹部発話量」を Edmondson 4 行動に細分化）── 出典：Edmondson 1999 ／ ① 失敗を率直に話せる ② わからないことを質問できる ③ 助けを求められる ④ 新しい方法を実験的に試せる ── の 4 行動の月次頻度・有無
