...
8. **★ 理論背景（theory-background-box・260508 夜 追加・権威性訴求・closing-note の直前に表示・1 段落）**
   ...
   **HTML 構造：**
   ...
   <div class="theory-background-box">
     <h4>このレポートの理論背景</h4>
     <p class="theory-intro">Gravity Scan は、以下の理論・先行研究を統合した独自フレームで組織の引力を診断します：</p>
     <ul class="theory-list">
       <li><strong>組織の引力理論</strong>（GrowthFix 独自・50 社診断ベース）── 集まる軸 × 躍動軸の 2 マトリクスで 4 型分類</li>
       <li><strong>引力 7 項目スコアリング</strong>（採用パイプ・最終辞退率・優秀人材定着率・幹部発話量・エンゲージメント・離脱予兆・採用最大壁の自覚度）── 50 社の組織診断データから抽出</li>
       <li><strong>能力の輪（マンガー）</strong>── 経営者の才能と組織の機能を整合させる思考フレーム</li>
       <li><strong>ネガティブ・ケイパビリティ（キーツ）</strong>── 答えのない時間に結論を出さず留まる経営者の覚悟確認</li>
