...
<div class="shift-fit-box shift-fit-box--primary">
  ...
  <p class="covenant-quadrant" style="margin-top:8px;font-size:9pt;color:#475569;"><strong>★ 覚悟確認 4 象限判定（260510 v0.4・必須出力）：</strong>このレポートでは経営者の覚悟確認を **必ず A/B/C/D の 4 象限ラベル**で明示します。**[判定：A 完全覚悟型 ／ B 結論先送り型 ／ C 単線思考型 ／ D 完全 have to 型 のいずれか]**</p>
</div>
