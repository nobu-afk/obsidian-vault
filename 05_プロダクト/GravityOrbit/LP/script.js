...
// Plan card CTA → auto-select plan in form
...
var orbitForm = document.getElementById("orbit-form");
if (orbitForm) {
  orbitForm.addEventListener("submit", function() {
    if (typeof fbq === "function") fbq("track", "Lead");
    var btn = orbitForm.querySelector('button[type="submit"]');
    if (btn) {
      btn.disabled = true;
      btn.textContent = "送信中...";
    }
